  ...
  return (
    <div className="trendingItem">
        ...
        
        {
           ...
           <span className="percentageChange positiveChange">{props.coin.price_change_percentage_24h.toFixed(2)}%</span>
         </div>
        }
         {
           props.coin.price_change_percentage_24h<0 &&  <div className="changeContainer">
           <span className="triangleDown"></span>
           <span className="percentageChange negativeChange">{props.coin.price_change_percentage_24h.toFixed(2)}%</span>
         </div>
        }
